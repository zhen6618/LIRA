...
def parse_args(args):
    ...
    parser.add_argument("--load_in_8bit", action="store_true", default=False)  # default=False
    parser.add_argument("--load_in_4bit", action="store_true", default=False)  # default=False
...
def main(args):
    ...
    while True:
        ...
        # prompt = input("Please input your prompt: ")  # chair
        prompt = 'chair'
        ...
        # image_path = input("Please input the image path: ")  # /root/paddlejob/workspace/env_run/zhouzhen05/Data/zhouzhen05/Data/scans/scene0209_00/color/color_1262.jpg
        image_path = '/root/paddlejob/workspace/env_run/zhouzhen05/Data/zhouzhen05/Data/scans/scene0209_00/color/color_1262.jpg'
        ...
        print("infer time: ", time.time() - t_infer_start)
        ...
        for i, pred_mask in enumerate(pred_masks):
            ...
            for mask_i in range(len(pred_mask)):
                ...
                save_path = "{}/{}_mask_{}.jpg".format(
                    args.vis_save_path, image_path.split("/")[-1].split(".")[0], mask_i
                )
